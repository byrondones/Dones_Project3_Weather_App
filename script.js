...
function searchCity(){
    ...
    if(searchCityInput.value != ""){
        ...
        let tempValue = Math.round(forCast.main.temp);
        let tempMinValue = Math.round(forCast.main.temp_min);
        let tempMaxValue = Math.round(forCast.main.temp_max);
        let tempFeelsValue = Math.round(forCast.main.feels_like);
